...
public class StaffView {
    ...
    public void renderStaffMenu() {
        System.out.println("Staff manager Menu");
        System.out.println("1. Show list Staff");
        System.out.println("2. Add new Staff");
        System.out.println("3. Edit Staff's profile");
        System.out.println("4. Delete Staff");
        System.out.println("5. Find Staff by name");
        System.out.println("6. Return Admin menu");
        System.out.println("7. Exit System");
    }
    public void renderUpdateStaffMenu() {
    ...
    private void showStaffView() {
        ...
        System.out.println("=======================================================================================================================================================");
        for (User p : userService.getAllStaff()) {
            System.out.println(p.toView());
            System.out.println("=======================================================================================================================================================");
        }
    }
    private void showStaffView(List<User> users) {
        System.out.println("=======================================================================================================================================================");
        System.out.printf("%10s|%20s|%15s|%15s|%15s|%15s|%12s|%12s|%20s\n","ID","NAME","USER NAME","PASSWORD","MOBILE","ADDRESS","GENDER","POSITION","CREAT DAY");
        System.out.println("=======================================================================================================================================================");
        for (User p : users) {
    ...
    public String inputUsername() {
        System.out.println("Enter Staff's user name");
        String username;
